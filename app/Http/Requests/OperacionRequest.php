...
class OperacionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'fecha_calendario_entrega'=>['required', new OperacionFechaRule, new OperacionHorarioEntregaRule, new OperacionHoraSedeEntregaRepetidoRule('sede_entrega')],
            'grupo' => 'required_if:optionsTipo,==,1|numeric',
            'orden' => 'required_if:optionsTipo,==,1|numeric|min:1|max:168',
            'nro_preventa' => 'required_if:optionsTipo,==,2|unique:operaciones',
        ];
    }
